...
<body>
    ...
    <div class="container-fluid">
                        ...
                        <div class="features_responsive">
                            <div class="row" >
                                <div
                                    ...
                                    <div class="wow">
                                        <h2 style="text-align: center; color: #ec0e71;"> Who We Are</h2>
                                        <div class="px-5" style="color: #fff;">
                                            <p style="text-align:center;">Beppers is a social media app designed exclusively for beauty and personal care, that connects people with beauty businesses and beauty freelancers.</p>
        ...
        <section id="howitworks">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="contact_area">
                           <h1 style="color: #ec0e71;">How It Works</h1>
                            <p class="px-5" style="color: #fff; text-align:center;">Valuvan needs a crew fade cut , he
                                explores it in
                                our social media
                ...
                <div class="blog-slider__wrp swiper-wrapper">
                  ...
                  <div class="blog-slider__item swiper-slide">
                    <div class="blog-slider__img">
                      <img width="300vw" height="550vh"   src="img/phone/7.png" alt="">
                    </div>
                    <div class="blog-slider__content ">
                      <p class="blog-slider__code display-8 fs-5 ">Network With Beauty Business and Free Lancers. </p>
                    </div>
                  </div>
                 
            <div class="blog-slider__item swiper-slide">
                    <div class="blog-slider__img">
                      <img width="300vw" height="550vh"   src="img/phone/2.png" alt="">
                    </div>
                    <div class="blog-slider__content">
                      <p class="blog-slider__code display-8 fs-5 ">Sign Up to explore what we have in the app.</p>
                    </div>
                  </div>
            <div class="blog-slider__item swiper-slide">
                    <div class="blog-slider__img">
                      <img  width="300vw" height="550vh"  src="img/phone/6.png" alt="">
                    </div>
                    <div class="blog-slider__content">
                      <p class="blog-slider__code display-8 fs-5 ">Create your profile with your authentic details.</p>
                    </div>
                  </div>
            <!-- <div class="blog-slider__item swiper-slide">
                    <div class="blog-slider__img">
                      <img  width="400vw" height="700vh"  src="img/slide/4.png" alt="">
                    </div>
                    <div class="blog-slider__content">
                      <p class="blog-slider__code display-8 fs-5">Search / Filter for your service.</p>
                    </div>
                  </div> -->
                  <div class="blog-slider__item swiper-slide">
                    <div class="blog-slider__img">
                      <img  width="300vw" height="550vh"  src="img/phone/8.png" alt="">
                    </div>
                    <div class="blog-slider__content">
                      <p class="blog-slider__code display-8 fs-5">Message to services provider
                     know prices & get an oppointment.</p>
                    </div>
                  </div>
            <!-- <div class="blog-slider__item swiper-slide">
                    <div class="blog-slider__img">
                      <img width="400vw" height="700vh"   src="img/slide/6.png" alt="">
                    </div>
                    <div class="blog-slider__content">
                      <p class="blog-slider__code display-8 fs-5 ">Sign Up to explore what we have in the app.</p>
                    </div>
            ...
            <div class="blog-slider__item swiper-slide">
                    <div class="blog-slider__img">
                      <img  width="300vw" height="550vh"  src="img/phone/1.png" alt="">
                    </div>
                    <div class="blog-slider__content">
                      <p class="blog-slider__code display-8 fs-5">Create & Setup the Profile by following simple steps.</p>
                    </div>
                  </div>
                  <div class="blog-slider__item swiper-slide">
                    <div class="blog-slider__img">
                    ...
                    <div class="blog-slider__content">
                      <p class="mx-4 blog-slider__code display-8 fs-5 ">Post your works as pictures and videos.</p>
                    </div>
                  </div>
            <div class="blog-slider__item swiper-slide">
                    <div class="blog-slider__img">
                    ...
                    <div class="blog-slider__content">
                      <p class="blog-slider__code display-8 fs-5 ">Connect and Respond to your customers in single click.</p>
                    </div>
                  </div>
                        ...
                        <div  id="users" class="row" >
                            <div
                                ...
                                <div class="wow fadeInUp">
                                    <h2 style="text-align: center; color: #ec0e71;"> Beauty Businesses & Freelancers
                                    </h2>
                                    <div class="px-5 py-4" style="color: #fff;">
                                    <ul style="list-style:none; line-height: 45px;">
                                        <li><i class="fa fa-rocket fa-lg" style="color: #D4AF37;"></i> Take your business online</li>
                                        <li><i class="fa fa-marker fa-lg" style="color: #ED0A76;"></i> show and share your skills</li>
                                        <li><img width="25" height="25" src="https://img.icons8.com/ios-filled/100/DBA6F7/groups.png" alt="groups"/> impress and attract more clients</li>
                                        <li><img width="25" height="25" src="https://img.icons8.com/glyph-neue/64/32CD32/business.png" alt="business"/> grow your business.</li>
                                    </ul>
                                    </div>
                    ...
                    <div class="features_responsive">
                        <div class="row" >
                            ...
                            <div class="col-lg-6 col-md-6 d-flex align-items-center mt-5 py-5">
                                <div class="wow fadeInUp">
                                    <h2 style="text-align: center; color: #ec0e71;"> People & Influencers </h2>
                                    <div class="px-5 py-4" style="color: #fff;">
                                    <ul style="list-style:none; line-height: 45px;">
                                        <li><img width="30" height="30" src="https://img.icons8.com/ios-filled/100/DAA5F6/cosmetic-brush.png" alt="cosmetic-brush"/> Choose your makeover</li>
                                        <li><img width="30" height="30" src="https://img.icons8.com/ios-glyphs/90/ED0A76/long-formal-dress.png" alt="long-formal-dress"/> explore current trends</li>
                                        <li><img width="30" height="30" src="https://img.icons8.com/glyph-neue/64/D4AF37/crown-and-lipstick.png" alt="crown-and-lipstick"/> meet your beauty needs</li>
                                        <li><img width="30" height="30" src="https://img.icons8.com/glyph-neue/64/0D98BA/volunteering.png" alt="volunteering"/> inspire beppers community.</li>
                                        </ul>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-center">
        ...
        <section id="features">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div>
                            <h1 style="color: #ec0e71;">Features</h1>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 py-4 mt-4 d-flex align-items-center justify-content-center">
                                <ul class="nav nav-pills flex-column  align-items-sm-start" id="menu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link px-0 align-start" style="color: #DBA6F7;">
                                            <i class="fs-4 bi bi-images"></i>
                                            <span class="ms-1 d-sm-inline" style="color: #fff;">   Post videos and pictures.</span></a>
                                    </li>
                          
                                    <li class="nav-item">
                                        <a class="nav-link px-0 align-start" style="color: #ED0A76;">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link px-0 align-start" style="color:#32CD32;">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link px-0 align-start" style="color: #0D98ba;">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link px-0 align-start" style="color: #d4af37">
                            ...
                            <div
                                ...
                                <img src="img/slider/post.jpg" alt="Nature" class="responsive2"
                                    style="border-radius: 10px;">
                            </div>
                        </div>
                    </div>
        ...
        <section id="contact">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="contact_area">
                            <h1 style="color: #ec0e71;">Get in touch</h1>
                            <p style="color: #fff;">Feel free to reach us from the contact form below.</p>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 order-2 order-md-1 order-lg-1 order-xl-1 order-xxl-1">
                                    <div class="contact_left wow fadeInLeft">
                                        <h1 style="color: #ec0e71;">Contact</h1>
                                        ...
                                        <div class="contact_social">
                                            <h1 style="color: #ec0e71;">Social</h1>
                                ...
                                <div class="col-lg-6 col-md-6 order-1 order-md-2 order-lg-2 order-xl-2 order-xxl-2">
                                    <div class="contact_right wow fadeInRight">
                                        ...
                                        if(isset($_POST['submit'])){
                                          ...
                                          $sql=mysqli_query($conn,"INSERT INTO contact_form(`name`, `email`,`message`)values('$name','$email','$message')");
                                          if ($sql>0) {
                                            ...
                                            echo "<script type='text/javascript'>
                                            alert('Something Wrong , Please Try Again Late....');
                                            </script>";
                                        }
